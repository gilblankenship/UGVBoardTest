...
void loop() {
  ...
  outputB = constrain(speedPIControl_B(inputB, setpointB, KpInputSet)*rightRate, -255, 255);
  outputA = constrain(speedPIControl_A(inputA, setpointA, KpInputSet)*leftRate, -255, 255);
